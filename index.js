...
const fs = require('fs');
//const fs = require('fs');
const ownerId = '1054360093526855680'; // apna developer id daal lena 
...
client.on('ready', async () => {
  ...
  const r = new Discord.RichPresence()
    .setApplicationId('1187589793337581611')
    .setType('STREAMING') 
    .setURL('https://discord.gg/tempestlegit ')
    .setState('Selling Members')

    .setName('Chandu on top')
    .setDetails('JOIN krle')


    .setStartTimestamp(Date.now())
    .setAssetsLargeImage('https://cdn.discordapp.com/avatars/1130665344206393475/7f790808f440ab7235d88595f85eee0b.png?size=1024')
    .setAssetsLargeText('...')
    .setAssetsSmallImage('https://cdn.discordapp.com/avatars/1130665344206393475/7f790808f440ab7235d88595f85eee0b.png?size=1024')
    .setAssetsSmallText('...')
        .addButton('Sellix', "https://discord.gg/evilx")
    .addButton('Join my server ',"https://discord.gg/evilx")
